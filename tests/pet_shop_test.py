...
class TestPetShop(unittest.TestCase):
    ...
    # Test 2 @unittest.skip("delete this line to run the test")
    def test_total_cash(self):
        sum = get_total_cash(self.cc_pet_shop)
        self.assertEqual(1000, sum)

    # Test 3 @unittest.skip("delete this line to run the test")
    ...
    # Test 18 @unittest.skip("delete this line to run the test")
    ...
    #
    # Test 21 - @unittest.skip("delete this line to run the test")
